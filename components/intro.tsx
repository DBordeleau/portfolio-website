  ...
  return (
    <section ref={ref} id='home' className='mb-[2rem] max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
      ...
      <motion.h1 className='mb-10 mt-4 px-4 text-[1.5rem] sm:text-[1.75rem] font-medium !leading-[1.25] sm:text-4x1'
        ...
        <span className="font-bold">systems/embedded systems programming and creative problem solving. </span>
        My current skills include:{" "}
        <span className="font-bold">C/C++, Java, Python, TypeScript/JavaScript, Communication Protocols (UART, I2C, SPI) and SQL/PostgreSQL.</span>
      </motion.h1>
