  ...
  return (
    ...
    id="about">
      ...
      <p className='mb-3 text-[1.05rem]'>
        ...
        full-time internship opportunities for Summer 2025 where I can continue to develop my full-stack development skills and excel as an important part of your team. {" "}
        </span>
