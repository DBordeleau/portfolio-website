  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 transition-all`}>
        ...
        <div className="bg-emerald-100 absolute -z-10 top-[-1rem] left-[-35rem] h-[50rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-emerald-900 dark:w-[30rem] dark:h-[30rem] dark:top-[5rem] dark:-left-[10rem]"></div>
